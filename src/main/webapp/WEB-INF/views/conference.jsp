...
<body>
	<div class="index-main">
		...
		<div class="headDiv">
			<h1 class="headThingy">${conference}</h1>
			<br>
			<br>
			<div class="container-fluid">
				<c:forEach var="college" items="${collegeList}">
					...
					<div class="col-md-6 col-xs-12">
						<div class="items">
							<h1>${college.name}</h1>
							<c:if test="${college.name=='Illinois' }">
							--- <a href="GetCollege.do?name=${college.name}"><img
								class="imgOff" src="pics/${college.pic}" /></a>---<br>
							</c:if>
							
							<c:if test="${college.name!='Illinois' }">
							--- <a href="GetCollege.do?name=${college.name}"><img
								class="imgSmall" src="pics/${college.pic}" /></a>---<br>
							</c:if>
							<br>
						</div>
						<br>
